...
CREATE DATABASE IF NOT EXISTS `bdimprenta` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `bdimprenta`;
...
-- Volcando datos para la tabla bdimprenta.cita: ~0 rows (aproximadamente)
INSERT INTO `cita` (`id_cita`, `fecha_hora`, `horario`, `estado`, `descripcion`, `f_creacion`, `id_cliente`, `id_empleado`) VALUES
...
-- Volcando datos para la tabla bdimprenta.detalle_pedido: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bdimprenta.empleado: ~0 rows (aproximadamente)
...
DELIMITER //
CREATE PROCEDURE `obtenerDPyD`(IN `codUbigeo` VARCHAR(10))
BEGIN
    SELECT 
        (SELECT descripcion 
         FROM ubigeo 
...
-- Volcando datos para la tabla bdimprenta.pedido: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bdimprenta.producto: ~0 rows (aproximadamente)
...
INSERT INTO `usuario` (`id_usuario`, `email`, `pass`, `tipo`, `estado`, `perfil_completo`, `cod_confirmacion`, `f_creacion`) VALUES
	...
	(3, 'marthaquispe.2003@gmail.com', '$2y$10$o4plXaPnFq1wSGZloReWmON5gQpqgFy9fkdkG7J9Sn/3fWG37oT3G', 'cliente', 'activo', NULL, '405099', '2024-10-31 18:18:56');
