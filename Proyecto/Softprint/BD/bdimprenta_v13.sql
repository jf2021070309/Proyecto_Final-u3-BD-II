...
INSERT IGNORE INTO `cliente` (`id_cliente`, `id_usuario`, `nombre`, `apellido`, `dni`, `celular`, `direccion`, `cod_ubigeo`) VALUES
	...
	(4, 8, 'Giacomo', 'Bocchio', '86566886', '929929599', '', '110302'),
...
-- Volcando datos para la tabla bdimprenta.detalle_pedido: ~16 rows (aproximadamente)
INSERT IGNORE INTO `detalle_pedido` (`id_pedido`, `id_producto`, `descripcion`, `altura`, `ancho`, `cantidad`, `id_insumo`, `url_img`) VALUES
...
INSERT IGNORE INTO `insumo` (`id_insumo`, `descripcion`, `stock`, `precio_compra`) VALUES
	...
	(13, 'Papel Couche A6', 1994, 45),
	(14, 'Roll Screen 0.8 m x 2 m', 5, 35),
...
-- Volcando datos para la tabla bdimprenta.pedido: ~15 rows (aproximadamente)
INSERT IGNORE INTO `pedido` (`id_pedido`, `id_cliente`, `id_empleado`, `fecha_pedido`, `estado`, `total`, `pagado`) VALUES
	...
	(12, 4, NULL, '2024-11-28 21:26:04', 'pendiente', 110.00, NULL),
