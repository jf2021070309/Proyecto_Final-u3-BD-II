...
-- Volcando datos para la tabla bdimprenta.cita: ~1 rows (aproximadamente)
...
INSERT INTO `cliente` (`id_cliente`, `id_usuario`, `nombre`, `apellido`, `dni`, `celular`, `direccion`, `cod_ubigeo`) VALUES
	(1, 2, 'Andree', 'Melendez', '76032957', '957084267', '', '230110'),
	(2, 3, 'Martha', 'Flores', '32424300', '981289891', '', '230108');
...
INSERT INTO `detalle_pedido` (`id_pedido`, `id_producto`, `descripcion`, `altura`, `ancho`, `cantidad`, `id_insumo`) VALUES
...
-- Volcando datos para la tabla bdimprenta.empleado: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bdimprenta.ingreso: ~7 rows (aproximadamente)
...
INSERT INTO `pedido` (`id_pedido`, `id_cliente`, `id_empleado`, `fecha_pedido`, `estado`, `total`) VALUES
	(1, 1, 1, '2024-11-18 15:00:00', 'pendiente', 280.00),
	(2, 1, 1, '2024-11-18 15:30:00', 'asignado', 112.00),
	(3, 1, 1, '2024-11-18 16:00:00', 'procesando', 75.00),
	(4, 2, 1, '2024-11-18 16:30:00', 'pendiente', 90.00),
...
-- Volcando datos para la tabla bdimprenta.proveedor: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla bdimprenta.usuario: ~3 rows (aproximadamente)
INSERT INTO `usuario` (`id_usuario`, `email`, `pass`, `tipo`, `estado`, `perfil_completo`, `cod_confirmacion`, `f_creacion`) VALUES
	...
	(3, 'marthaflores.2003@gmail.com', '$2y$10$o4plXaPnFq1wSGZloReWmON5gQpqgFy9fkdkG7J9Sn/3fWG37oT3G', 'cliente', 'activo', NULL, '405099', '2024-10-31 18:18:56');
