...
-- Tiempo de generación: 31-10-2024 a las 20:37:48
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtenerDPyD` (IN `codUbigeo` VARCHAR(10))   BEGIN
    SELECT 
        (SELECT descripcion 
         FROM ubigeo 
...
INSERT INTO `cita` (`id_cita`, `fecha_hora`, `estado`, `descripcion`, `f_creacion`, `id_cliente`, `id_empleado`) VALUES
(1, '2024-11-05 09:00:00', 'programada', 'Reunión para discutir el diseño del proyecto', '2024-10-31 19:25:05', 1, 1);
