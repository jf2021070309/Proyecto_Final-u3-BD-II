...
-- Volcando datos para la tabla bdimprenta.cliente: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla bdimprenta.detalle_pedido: ~8 rows (aproximadamente)
INSERT IGNORE INTO `detalle_pedido` (`id_pedido`, `id_producto`, `descripcion`, `altura`, `ancho`, `cantidad`, `id_insumo`) VALUES
	...
	(5, 5, 'Lonas luminosas para exteriores', 250, 180, 1, 3),
...
-- Volcando datos para la tabla bdimprenta.insumo: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla bdimprenta.pedido: ~6 rows (aproximadamente)
INSERT IGNORE INTO `pedido` (`id_pedido`, `id_cliente`, `id_empleado`, `fecha_pedido`, `estado`, `total`) VALUES
	(1, 1, NULL, '2024-11-18 15:00:00', 'pendiente', 280.00),
	(2, 1, 1, '2024-11-18 15:30:00', 'asignado', 112.00),
	(3, 1, 1, '2024-11-18 16:00:00', 'procesando', 75.00),
	(4, 2, NULL, '2024-11-18 16:30:00', 'pendiente', 90.00),
	(5, 2, 1, '2024-11-18 17:00:00', 'asignado', 140.00),
	(6, 2, 1, '2024-11-18 17:30:00', 'completado', 25.00);
...
-- Volcando datos para la tabla bdimprenta.usuario: ~5 rows (aproximadamente)
