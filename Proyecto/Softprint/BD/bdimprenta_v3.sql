...
-- Tiempo de generación: 31-10-2024 a las 08:37:40
...
(2, 'Papel fotografico', 40, 10),
(3, 'Cartulina de color', 50, 3),
(5, 'Hoja de color', 5, 2),
(6, 'Tinta de máquina', 30, 40),
(7, 'Papelografo', 15, 5);
...
--
ALTER TABLE `ingreso`
  ADD CONSTRAINT `fk_proveedor` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id_proveedor`) ON DELETE CASCADE,
