...
CREATE TABLE IF NOT EXISTS `cita` (
  ...
  `horario` enum('09:00','10:00','15:00','16:00') DEFAULT NULL,
...
-- Volcando datos para la tabla bdimprenta.cita: ~3 rows (aproximadamente)
INSERT IGNORE INTO `cita` (`id_cita`, `fecha`, `horario`, `estado`, `descripcion`, `f_creacion`, `id_cliente`, `id_empleado`) VALUES
	(1, '2024-11-05 09:00:00', NULL, 'programada', 'Reunión para discutir el diseño del proyecto', '2024-10-31 19:25:05', 1, 1),
	(5, '2024-11-25 00:00:00', '09:00', 'programada', 'Cita 1', '2024-11-25 09:39:53', 1, 1),
	(6, '2024-11-25 00:00:00', '16:00', 'programada', 'Cita 2', '2024-11-25 12:11:35', 1, 1);
...
-- Volcando datos para la tabla bdimprenta.cliente: ~3 rows (aproximadamente)
INSERT IGNORE INTO `cliente` (`id_cliente`, `id_usuario`, `nombre`, `apellido`, `dni`, `celular`, `direccion`, `cod_ubigeo`) VALUES
...
-- Volcando datos para la tabla bdimprenta.detalle_pedido: ~10 rows (aproximadamente)
INSERT IGNORE INTO `detalle_pedido` (`id_pedido`, `id_producto`, `descripcion`, `altura`, `ancho`, `cantidad`, `id_insumo`) VALUES
	(1, 2, 'Millar de volantes publicitarios', 29.7, 21, 1, 5),
	(2, 3, 'Stickers adhesivos personalizados', 10, 10, 2, 3),
	(2, 7, 'Pines personalizados (100 unidades)', NULL, NULL, 1, 6),
	(3, 1, 'Tarjetas de presentación estándar', 9, 5, 1, 2),
	(4, 6, 'Roll Screen con impresión personalizada', 100, 85, 1, 6),
	(5, 4, 'Banner delgado (8 onzas)', 200, 150, 2, 7),
	(6, 5, 'Lona publicitaria personalizada', 200, 200, 1, 3),
	(7, 1, 'Tarjeta Mate Millar con nombre Blast ', 5.5, 9, 1, 16),
	(8, 6, 'Estructura + Impresión (1m x 0.85m) x 4 unidades', 100, 0.85, 4, 14),
	(9, 5, 'Lona x 5 unidades', 24, 26, 5, 8);
...
INSERT IGNORE INTO `empleado` (`id_empleado`, `id_usuario`, `nombre`, `apellido`, `celular`, `cargo`, `sueldo`, `fecha_contratacion`) VALUES
...
INSERT IGNORE INTO `ingreso` (`id_ingreso`, `id_insumo`, `fecha`, `cantidad`, `costo_unitario`, `observaciones`, `id_proveedor`) VALUES
...
-- Volcando datos para la tabla bdimprenta.insumo: ~21 rows (aproximadamente)
INSERT IGNORE INTO `insumo` (`id_insumo`, `descripcion`, `stock`, `precio_compra`) VALUES
	(1, 'Banner delgado 1.6 m', 300, 10.5),
...
BEGIN
    SELECT 
        (SELECT descripcion 
         FROM ubigeo 
         WHERE cod_ubigeo = codUbigeo) AS DESCRIPCION,
         
        (SELECT descripcion 
         FROM ubigeo 
         WHERE cod_ubigeo = (SELECT cod_ubigeo_sup 
                             FROM ubigeo 
                             WHERE cod_ubigeo = codUbigeo)) AS PROVINCIA,
        ...
        (SELECT descripcion 
         ...
         WHERE cod_ubigeo = (SELECT cod_ubigeo_sup 
                             ...
                             WHERE cod_ubigeo = (SELECT cod_ubigeo_sup 
                                                 FROM ubigeo 
                                                 WHERE cod_ubigeo = codUbigeo))) AS DEPARTAMENTO;
END//
DELIMITER ;
...
-- Volcando datos para la tabla bdimprenta.pedido: ~9 rows (aproximadamente)
INSERT IGNORE INTO `pedido` (`id_pedido`, `id_cliente`, `id_empleado`, `fecha_pedido`, `estado`, `total`, `pagado`) VALUES
	...
	(4, 2, NULL, '2024-11-18 16:30:00', 'pendiente', 90.00, 0),
	...
	(8, 1, NULL, '2024-11-28 12:24:27', 'pendiente', 360.00, NULL),
...
INSERT IGNORE INTO `producto` (`id_producto`, `nombre`, `precio_base`, `unidad_venta`) VALUES
...
INSERT IGNORE INTO `proveedor` (`id_proveedor`, `nombre`, `ruc`, `celular`, `email`, `direccion`) VALUES
...
INSERT IGNORE INTO `ubigeo` (`cod_ubigeo`, `descripcion`, `cod_ubigeo_sup`) VALUES
	('01', 'AMAZONAS', ''),
	('0101', 'CHACHAPOYAS', '01'),
	...
	('190108', 'SAN FCO.DE ASIS DE YARUSYACAN', '1901'),
...
-- Volcando datos para la tabla bdimprenta.usuario: ~6 rows (aproximadamente)
INSERT IGNORE INTO `usuario` (`id_usuario`, `email`, `pass`, `tipo`, `estado`, `perfil_completo`, `cod_confirmacion`, `f_creacion`) VALUES
